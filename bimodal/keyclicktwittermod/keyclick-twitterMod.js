/*  
KEYCLICK TWITTER MOD

------------------------------------
(PASTE INTO WEB DEVTOOLS CONSOLE)
------------------------------------

- Demonstrates a keyboard-driven desktop social media site
- Replaces common mouse button clicks with key commands for opening links, clicking on buttons.
- Serves as a reference adapting desktop website applications to keyboard-centric 
...
F	- Click the element under the cursor (link, button, or any element), usually outlined in green.
G	- Open/Close the hovered tweet only.
D	- Delete the hovered tweet from the page.
===================================
...
(() => {
  ...
  style.textContent = `
    ...
    .xv2-avatar { width: 80px; height: 80px; border-radius: 0%; overflow: hidden; flex: 0 0 auto; background: rgba(0,0,0,0.15); box-shadow: 0 0 0 1px rgba(0,0,0,0.08) inset;     border: 3pt solid black;}
    ...
    .xv2-preview {
      ...
      display: inline-block;        /* valid value */
      background: #00000087;
      padding: 3pt;
      border-radius: 4pt;
      border: 3pt solid black;
      backdrop-filter: sepia(90%) blur(3px);
    }
   ...
   // .xv2-content { overflow: hidden; transition: max-height 200ms ease-in-out; max-height: 0; margin-top: 8px; }
    ...
    /* Big 70pt SVG crosshair cursor with ~1pt glow */
body.x-big-cursor, body.x-big-cursor * {
  cursor: url("data:image/svg+xml;utf8,\
<svg xmlns='http://www.w3.org/2000/svg' width='94' height='94' viewBox='0 0 94 94'>\
  <defs>\
    <!-- ~1pt glow → ~1.333 px at 96 dpi -->\
...
(() => {
  ...
  modal.innerHTML = `
    ...
    <table>
      <tr><td><kbd style="background-color:green;color:white;">F</kbd></td><td>Click the element under the cursor 
      (link, button, or any element), usually outlined in green.</td></tr>
      <tr><td><kbd>G</kbd></td><td>Open/Close the hovered tweet.</td></tr>
 ...
 // document.body.classList.add('x-g-crosshair');
  document.body.classList.add('x-big-cursor');
...
function rippleAt(x, y) {
  ...
  function disable() {
    ...
    document.body.classList.remove('x-big-cursor');
